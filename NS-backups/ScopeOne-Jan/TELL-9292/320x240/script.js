...
lemonpi.subscribe(function callback(content) {
  ...
  // All videos
  $('.videoFirst').append('<video muted autoplay="autoplay" style="width:450px;" src="' + content.videoFirst.value + '"></video>');
/*   
  setTimeout(function () {
    $('.videoSecond').append('<video muted autoplay="autoplay" style="width:220px;" src="' + content.videoSecond.value + '"></video>');
  }, 7700);
